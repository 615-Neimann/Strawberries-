...
I did the same thig for the non-bearing acres here
```{r}
...
last we apply both functions to the straw_cen data to fill in some of the NA's with the correct ratios based on the total numbers. It should be noted that the function does not work for states that did not have total values for specific size_brackets 
